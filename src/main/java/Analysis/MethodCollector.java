...
public class MethodCollector {
    ...
    public MethodCollector(String srcPath, String FILE_PATH, String projectName, String repositoryId, String star) {
...
//            System.out.println("filename:" + filename);
            ...
            String outputFileName0 = name + testOrProduct + "+" + packageName + "+" + filename + "+" + methodName + "+" + typeString + ".txt";

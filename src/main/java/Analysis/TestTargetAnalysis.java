...
public class TestTargetAnalysis {
    ...
    String star;
    String SRC_PATH;
    String ROOT_PATH = "D:/avaire_99215275_49/src";
    int testFramework;
    int junitVersion;
    int assertFramework;
...
//        testTargetAnalysis tta = new testTargetAnalysis("D:/avaire_99215275_49/src");
//        List<String> fileNames = new ArrayList<String>();
//        tta.findFileList(new File("C:/Users/77627/IdeaProjects/JavaParserDemo/avaire_99215275_49_Test Class"), fileNames);
//        int count = 0;
